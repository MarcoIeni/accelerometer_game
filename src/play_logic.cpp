...
/**
 *  \brief Get the elapsed time between two interrupts, generated from the
 * button or from the accelerometer.
 ...
 *  \param val the value for which to evaluate the absolute value.
